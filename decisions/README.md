...
| [0008](0008-identity-capture-keyboard-ux-rework.md) | Identity-capture keyboard/text-entry UX reworked to explicit modes | Accepted | 2026-07 | Neeraj Grotra (founder), via Design Council review |
| [0009](0009-identity-onboarding-premium-redesign.md) | Identity-capture screen redesigned for a premium, emotionally-intelligent feel | Accepted | 2026-07 | Neeraj Grotra (founder), via Design Council review |
| [0010](0010-next-moment-engine-design-council.md) | Next-Moment Engine choreography and architecture: Design Council review | Accepted | 2026-07 | Neeraj Grotra (founder), via Design Council review |
| [0011](../docs/pdr/PDR-0011-adaptive-growth-autonomy-architecture.md) | Adaptive Growth & Autonomy Architecture (filed at a nonstandard path — flagged in the record itself, not yet relocated) | Proposed | 2026-07 | Neeraj Grotra (founder) |
| [0012](0012-life-dimension-engine-and-vision-canvas.md) | Life Dimensions replace static thought content; Vision Canvas replaces the single vision-card | Proposed | 2026-07 | Neeraj Grotra (founder) |
| [0013](0013-runtime-reconciliation-and-concept-consolidation.md) | Runtime reconciliation and concept consolidation (architectural content — belongs at `adr/0009` by convention, filed here per explicit instruction; supersedes `adr/0008`) | Proposed | 2026-07 | Neeraj Grotra (founder) |
